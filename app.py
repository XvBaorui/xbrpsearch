...
st.set_page_config(
    ...
    page_icon=f"data:image/svg+xml;base64,{st.base64.b64encode(LOGO_SVG.encode()).decode()}",
    layout="wide",
...
if not st.session_state.search_submitted:
    ...
    st.markdown(
        ...
        <div style='text-align:center; margin-top:80px; margin-bottom:30px;'>
            {LOGO_SVG.replace('width="24"', 'width="80" height="80" stroke="#2E86AB"')}
...
# -------------------------- 任务3：搜索后 —— 筛选+结果新页面 --------------------------
    ...
    st.markdown(
        ...
        <div style='display:flex; align-items:center; justify-content:center; gap:10px; margin-bottom:20px;'>
            {LOGO_SVG.replace('width="24"', 'width="32" height="32" stroke="#2E86AB"')}
